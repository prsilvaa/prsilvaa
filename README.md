...
<table border="1">
    ...
    <tr>
        <td><strong>Splunk Log Analysis</strong></td>
        <td>Log parsing, SPL queries, Data visualisation, Web transaction analysis, Security and business insight</td>
        <td>Splunk, SPL, Apache Web Logs, Dashboards</td>
        <td><a href="https://github.com/prsilvaa/Splunk">Splunk</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Linux fundamentals, File management, Administration, Networking, Server setup, Apache</td>
        <td>Shell, vi Editor, Apache, SELinux, Firewall, Networking, Mail</td>
